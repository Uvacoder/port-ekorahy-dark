...
function UnderDevelopmentSection() {
  return (
    <div className="w-full h-max text-center block mx-auto">
        <h1 className="text-secondary font-Bungee text-2xl font-bold md:text-3xl">- Coming Soon -</h1>
        <h2 className="text-lg text-secondary font-Kanit font-bold lg:text-xl">This page is under Development</h2>
